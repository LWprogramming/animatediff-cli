...
def generate(
    ...
    head_prompt: Annotated[
        Optional[str],
        typer.Option(
            "--head-prompt",
            help="OPTIONAL: Override the head prompt from the model config",
            rich_help_panel="Advanced",
        ),
    ] = None,
    tail_prompt: Annotated[
        Optional[str],
        typer.Option(
            "--tail-prompt",
            help="OPTIONAL: Override the tail prompt from the model config",
            rich_help_panel="Advanced",
        ),
    ] = None,
    prompt_map: Annotated[
        ...
        typer.Option(
            "--prompt-map",
            help="OPTIONAL: Override the prompt map from the model config",
            rich_help_panel="Advanced",
        ),
    ] = None,
    n_prompt: Annotated[
